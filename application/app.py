...
if '{model_dir}/dict.en.txt' == False:
    shutil.copy('{preprocess_dir}/dict.en.txt', '{model_dir}')

if '{model_dir}/dict.ja.txt' == False:
    shutil.copy('{preprocess_dir}/dict.ja.txt', '{model_dir}')
